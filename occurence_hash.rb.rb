...
#
# string  - The String to be used for counting characters which is passed as command line argument.
#
# Examples
#
...
#
# Returns the hash having characters as their keys and their no. of occurences as values.
if ARGV.empty?
